<p align="center">
	<img src="https://img.shields.io/badge/PATCH-v%2011.6.1-green.svg" alt="for humans">
</p>
...
All champions from
```
http://ddragon.leagueoflegends.com/cdn/11.6.1/data/en_US/champion.json
```
with dependences to (Splashes,Loading screens,Avatars)
```
http://ddragon.leagueoflegends.com/cdn/11.6.1/data/en_US/champion/ChampionName.json
```
    ...
    "data": [
        {
            ...
            "square":
            {
                "link": "http://ddragon.leagueoflegends.com/cdn/11.6.1/img/champion/Aatrox.png"
            }
        }
        // ...
        // ...
